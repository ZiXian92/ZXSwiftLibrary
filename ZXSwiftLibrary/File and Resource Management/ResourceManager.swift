...
/**
    Defines the component that provides reference counting mechanism for file resources.
    File resources include: Text and image files.
 */
public class ResourceManager {
    ...
    public func resourceOfType(type: ResourceType) -> [String] {
    ...
    public func referenceCountForResource(resourceName: String) -> Int {
    ...
    public func retainResource(resourceName: String) {
    ...
    ///
    /// :param: baseName The base name of the text file to save to.
    ...
    public func retainResource(baseName: String, text: String) -> String {
    ...
    public func retainResource(baseName: String, image: UIImage, imageType: ImageType) -> String {
        var filename = baseName
    ...
    public func releaseResource(resourceName: String) {
        if _referenceCountTable[resourceName] != nil {
